            ...
            <div className="lg:col-span-6 space-y-4">
              ...
              <div className="pt-2 flex items-center gap-3">
                <button 
                  ...
                  className="w-full sm:w-auto px-5 py-2.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-white font-bold text-xs flex items-center justify-center gap-2 transition-all">
